...
| # | 模型 | 综合能力 | 单次价格 (USD) | 推理 |
|---|------|---------|---------------|------|
| 1 | GPT-5.5 (xhigh) | 0.9023 | $0.3125 | 🧠 |
| 2 | Gemini 3.1 Pro Preview | 0.9000 | $0.0944 | 🧠 |
| 3 | Claude Opus 4.7 (max) | 0.8480 | $0.0555 | 🧠 |
| 4 | Grok 4.3 | 0.7874 | $0.0075 | 🧠 |
| 5 | MiMo-V2.5 | 0.7104 | $0.0072 | 🧠 |
| 6 | DeepSeek V4 Flash (Max) | 0.6811 | $0.0039 | 🧠 |
| 7 | GPT-5.4 nano (xhigh) | 0.6567 | $0.0020 | 🧠 |
